...
2) เปิด `notebooks/Person_Detection_YOLOv8_Colab.ipynb` ใน Google Colab  [Open in Colab](https://colab.research.google.com/github/NKRAFAVoiceAI/REPO/blob/main/notebooks/Person_Detection_YOLOv8_Colab.ipynb)
